...
// See dungeon.c for all the helper functions

// Define a macro to help obfuscate bare pointer arithmetic
#define MAP(a, b) map[(a) * d->width + (b)]

// Have to forward declare due to circular dependencies
...
// Places the PC randomly in the dungeon. WILL NEED TO BE CHANGED LATER.
