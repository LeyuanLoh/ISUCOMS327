#ifndef ROGUE_DUNGEON_PARAMETERS_H
#define ROGUE_DUNGEON_PARAMETERS_H

// This file sets all defaults and compile time settings related to dungeon generation... some of these parameters should not be changed and will cause
...
#define NUM_HARDNESS_LEVELS 6
#define ROOM_WEIGHT 1
#define ROCK_WEIGHT 5
#define CORRIDOR_WEIGHT 0
...
#endif //ROGUE_DUNGEON_PARAMETERS_H
