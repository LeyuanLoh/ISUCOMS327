...
// This file sets all the misc Settings that don't belong under others, like the default save locations.

// Current assignment due
#define VERSION "assignment-1.02"
...
#define PGM_COMMENT "# CREATOR: Eddie Mahoney's CS327 RLG"
